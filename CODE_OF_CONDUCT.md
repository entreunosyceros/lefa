...
- Acaso público o privado
- Publicar información privada de otras personas, como una dirección física o electrónica, sin permiso explícito
- Compartir en issues o PRs datos fiscales reales de terceros (NIF, facturas, importes de clientes)
...
Los casos de comportamiento abusivo, acosador o inaceptable pueden reportarse abriendo un issue en [GitHub](https://github.com/entreunosyceros/lefa/issues) con el título **«Conducta»** (sin incluir detalles sensibles en público si no es necesario). También puedes usar [GitHub Security Advisories](https://github.com/entreunosyceros/lefa/security/advisories) para comunicación privada cuando proceda.
