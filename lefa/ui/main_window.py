...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        self.tab_inicio.ir_servicios.connect(self._mostrar_servicios)
        self.tab_inicio.ir_plantillas.connect(self._mostrar_plantillas)
        ...
        self.tab_presupuesto.convertido_en_factura.connect(self._abrir_factura_desde_presupuesto)
